...
public class RandomMatchToHandAction extends AbstractGameAction {
    private AbstractPlayer p;
    private AbstractCard match;

    public RandomMatchToHandAction(int amount, AbstractCard c) {
    ...
    public void update() {
        if (this.duration == Settings.ACTION_DUR_MED) {// 26
            ...
            while (var2.hasNext()) {
                ...
                if (card.name.equals(match.name)) {// 35
